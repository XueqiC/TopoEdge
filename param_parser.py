...
def parse_args():
    ...
    parser.add_argument('--method', type=str, default='tq', 
                        help='choose from [none, qw, tq], qw: quantity reweight, tq: topological weight ') 
    ...
    parser.add_argument('--k', type=float, default=0, help='topo k percentage edges for mixup')
